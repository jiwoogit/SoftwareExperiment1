...
public class SelectingMargaritaQuantity implements ActionListener{
	
	MenuItem Margarita = new MenuItem("Margarita",790000);
	public SelectingMargaritaQuantity(){
		MenuItem Margarita = new MenuItem("Margarita",790000);
	}
	...
	public void actionPerformed(ActionEvent e){
		...
		menu_label.setText(Margarita.getMenuName());
		...
		menu_sp.addChangeListener(new ChangeListener(){
			public void stateChanged(ChangeEvent e){
				Bartender.numMargarita = (Integer)menu_sp.getValue();
				Integer totalcost =Bartender.numMargarita*Margarita.menuCost();
